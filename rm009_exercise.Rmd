---
title: 'rm009 exercise: tidy data'
...
#left side retained and the right side into a new column
...
#meal_golf, no meal for golf so an just use dplyr to get rid of that column
